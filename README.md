...
| **Converter** | PDF → **Word** (`docx`, text with page breaks and heading sizes), **Excel** (SheetJS, one worksheet per page, text fragments as cells), **PowerPoint** (`pptxgenjs`, each page as a full-bleed slide image) and **Images** (one PNG/JPEG per page, zipped) — all generated in the browser. |
