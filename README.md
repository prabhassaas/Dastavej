...
| **AI assistant (floating)** | A chat bubble in the bottom-right corner of every page, sharing the same AI configuration as the workbench above. Chat freely, generate content and download it straight to PDF, or ask "how do I split a PDF" / "how do I add a watermark" for step-by-step feature guidance. |
